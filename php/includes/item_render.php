    ...
    if (!empty($irow)) {
        ...
        if (!$holo) {
            if ($irow['abstratus'] != "notaweapon" && $irow['abstratus'] != "") {
                echo '<div>Abstratus: <span style="font-weight:bold">' . $irow['abstratus'] . '</span></div>';
            }
            if ($irow['wearable'] != "none" && $irow['wearable'] != "") {
                echo '<div>Wearable type: <span style="font-weight:bold">' . $irow['wearable'] . '</span></div>';
            }

            if (!empty($irow['power'])) {
                echo '<table class="powertable">';
                echo '<tr><td>power</td><td>' . $irow['power'] . '</td></tr>';
                if (!empty($irow['aggrieve'])) {
                    echo '<tr><td>aggrieve</td><td>' . bonusStr($irow['aggrieve']) . '</td></tr>';
                }
                if (!empty($irow['aggress'])) {
                    echo '<tr><td>aggress</td><td>' . bonusStr($irow['aggress']) . '</td></tr>';
                }
                if (!empty($irow['assail'])) {
                    echo '<tr><td>assail</td><td>' . bonusStr($irow['assail']) . '</td></tr>';
                }
                if (!empty($irow['assault'])) {
                    echo '<tr><td>assault</td><td>' . bonusStr($irow['assault']) . '</td></tr>';
                }
                if (!empty($irow['abuse'])) {
                    echo '<tr><td>abuse</td><td>' . bonusStr($irow['abuse']) . '</td></tr>';
                }
                if (!empty($irow['accuse'])) {
                    echo '<tr><td>accuse</td><td>' . bonusStr($irow['accuse']) . '</td></tr>';
                }
                if (!empty($irow['abjure'])) {
                    echo '<tr><td>abjure</td><td>' . bonusStr($irow['abjure']) . '</td></tr>';
                }
                if (!empty($irow['abstain'])) {
                    echo '<tr><td>abstain</td><td>' . bonusStr($irow['abstain']) . '</td></tr>';
                }
                echo '</table>';
            }
        }
